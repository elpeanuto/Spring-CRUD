package com.elpeanuto.caloriesWeb.dao;

import com.elpeanuto.caloriesWeb.models.Person;
...
public class PersonDAO {
    ...
    public void save(Person person) {
        jdbcTemplate.update("INSERT INTO people(name, age, email) VALUES(?, ?, ?)", person.getName(), person.getAge(),
                person.getEmail());
    }
